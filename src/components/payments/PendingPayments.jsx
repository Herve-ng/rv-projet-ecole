  ...
  const renderFeeItem = (fee) => (
    <div className="px-6 py-4 flex items-center justify-between hover:bg-gradient-to-r hover:from-secondary-50/30 hover:to-primary-50/30 transition-all duration-200 rounded-lg">
      <div className="flex items-center flex-1 space-x-4">
        <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-lg border border-secondary-100 p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-secondary-600 font-semibold uppercase tracking-wide">En attente de paiement</p>
              <p className="text-2xl font-bold bg-gradient-to-r from-yellow-600 to-yellow-700 bg-clip-text text-transparent">{sortedFees.length}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-secondary-100 p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-secondary-600 font-semibold uppercase tracking-wide">Total déjà perçu</p>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-secondary-100 p-6 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-secondary-600 font-semibold uppercase tracking-wide">Montant restant total</p>
            ...
            <div className="bg-gradient-to-br from-red-400 to-red-600 p-3 rounded-xl shadow-md">
        ...
        action={
          <div className="flex space-x-2 items-center">
            ...
            <select
              ...
              className="px-3 py-2 text-sm border-2 border-secondary-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-primary-500 hover:border-secondary-300 transition-all duration-200 bg-white shadow-sm"
            >
        ...
        {viewMode === 'grouped' ? (
          ...
          <div className="space-y-2">
            {sortedFees.map((fee, index) => (
              <div key={index} className="border-2 border-secondary-100 rounded-xl hover:shadow-lg transition-all duration-200">
                {renderFeeItem(fee)}
              </div>
            ))}
          ...
          <form onSubmit={handleSubmitPayment}>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-2.5 border-2 border-secondary-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-primary-500 hover:border-secondary-300 transition-all duration-200 bg-white shadow-sm"
              >
